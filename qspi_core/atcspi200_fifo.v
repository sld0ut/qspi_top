...
reg		txf_clr_level;
reg		rxf_clr_level;
wire		txf_clr_sclk, txf_clr_ack;
wire		rxf_clr_sclk, rxf_clr_ack;
...
nds_sync_l2l txf_clr_ack_sync(
	.b_reset_n			(sysrstn),
	.b_clk				(sysclk),
	.a_signal			(txf_clr_sclk),
	.b_signal			(txf_clr_ack),
	.b_signal_rising_edge_pulse	(),
	.b_signal_falling_edge_pulse	(),
	.b_signal_edge_pulse		()
);
...
defparam u_spi_txfifo.DATA_WIDTH = 32;
defparam u_spi_txfifo.FIFO_DEPTH = `ATCSPI200_TXFIFO_DEPTH;
defparam u_spi_txfifo.POINTER_INDEX_WIDTH = `ATCSPI200_TXFPTR_BITS;
nds_async_fifo_clr u_spi_txfifo(
	.w_reset_n(sysrstn),
	.r_reset_n(spi_rstn),
	.w_clk(sysclk),
	.r_clk(spi_clock),
	.w_fifo_clr(txf_clr_level),
	.r_fifo_clr(txf_clr_sclk),
	.wr(txf_wr),
	.wr_data(txf_wr_data),
	.rd(txf_rd),
	.rd_data(txf_rd_data),
...
nds_sync_l2l rxf_clr_ack_sync(
	.b_reset_n			(sysrstn),
	.b_clk				(sysclk),
	.a_signal			(rxf_clr_sclk),
	.b_signal			(rxf_clr_ack),
	.b_signal_rising_edge_pulse	(),
	.b_signal_falling_edge_pulse	(),
	.b_signal_edge_pulse		()
);

defparam u_spi_rxfifo.DATA_WIDTH = 32;
defparam u_spi_rxfifo.FIFO_DEPTH = `ATCSPI200_RXFIFO_DEPTH;
defparam u_spi_rxfifo.POINTER_INDEX_WIDTH = `ATCSPI200_RXFPTR_BITS;
nds_async_fifo_clr u_spi_rxfifo(
	.w_reset_n(spi_rstn),
	.r_reset_n(sysrstn),
	.w_clk(spi_clock),
	.r_clk(sysclk),
	.w_fifo_clr(rxf_clr_sclk),
