`ifdef ATCSPI200_CONST_VH
`else
`define ATCSPI200_CONST_VH

`define ATCSPI200_ID		20'h02002
`define ATCSPI200_REV_MAJOR	8'h04
`define ATCSPI200_REV_MINOR	4'h0
...
`define ATCSPI200_TXFIFO_DEPTH		(2 ** (`ATCSPI200_TXFPTR_BITS - 1))
...
`define ATCSPI200_RXFIFO_DEPTH		(2 ** (`ATCSPI200_RXFPTR_BITS - 1))
